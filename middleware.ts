...
export function middleware(req: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://cdn.portone.io https://apis.google.com https://*.firebaseapp.com",
      ...
      "frame-src 'self' https://cdn.portone.io https://*.firebaseapp.com https://apis.google.com https://accounts.google.com",
      "object-src 'none'",
      "base-uri 'self'",
    ].join("; ")
  );
